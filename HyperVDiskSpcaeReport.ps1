...
# EMAIL PROPERTIES 
 # Set the recipients of the report. 
  $users = "operations.server@invesco.com" 
...
# REPORT PROPERTIES 
 # Path to the report 
  $reportPath = "D:\Scripts\HyperVDiskSpaceReport\Reports"; 
...
$computers = Get-Content "D:\Scripts\HyperVDiskSpaceReport\servers.txt"; 
...
$header = " 
  ...
  <font face='tahoma' color='#003399' size='4'><strong>HyperV Environment DiskSpace Report for $titledate</strong></font> 
  </td> 
  </tr> 
  </table> 
" 
...
# Create table at end of report showing legend of colors for the critical and warning 
 ...
 <tr bgcolor='White'> 
    <td width='10%' align='center' bgcolor='#FBB917'>Warning less than 10% free space</td> 
...
{ 
  ...
  $msg.To.Add($user) 
        $msg.From = "MBFN6270@invesco.com" 
  $msg.Subject = "HyperVEnvironment DiskSpace Report for $titledate" 
        $msg.IsBodyHTML = $true 
