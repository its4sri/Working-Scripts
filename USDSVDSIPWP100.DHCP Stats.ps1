...
# Report Header
$Header = "<H2 align=center><font face=Arial>$DomainName USDSVDSIPWP100 (Greenspoint)-DHCP Scope Statistics as of $Time on $CurrDate</font></H2>"  
...
$subject = "USDSVDSIPWP100 DHCP Scope Statistics" 
$body = Get-Content "D:\USDSVDSIPWP100.htm" 
